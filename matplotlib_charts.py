...
ax4.plot(plot_data['OBV'], color='#26a69a', label='OBV', linewidth=3, alpha=0.3)
ax4.plot(plot_data['OBV_EMA'], color='#f44336', label='OBV_EMA', linewidth=3, alpha=0.3)
ax4.legend()
ax4.set_title(ticker + ' OBV')

ax5.plot(stock_data[['Adj Close', '30 Day MA', 'Upper Band', 'Lower Band']])
ax5.legend()
ax5.set_title(ticker + ' Bollinger Band')
